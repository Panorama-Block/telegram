...
export function SwapPage() {
  const { user, loading, error, initData } = useTelegramUser();
        ...
        >
          <header style={{ textAlign: 'center' }}>
            ...
            <p style={{
              ...
              Faça swaps de tokens entre diferentes blockchains de forma rápida e segura.
            </p>
          </header>

          <SmartWalletConnectPanel />

          <Suspense fallback={<div style={{ marginTop: 12 }}>Loading swap interface…</div>}>
            <SwapCardLazy />
          </Suspense>
        </div>
      </main>
