      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative min-h-[600px]">
          ...
          <div className="absolute left-0 top-0 bottom-0 w-1/4 pointer-events-none z-0">
            <div className="absolute inset-0 bg-[linear-gradient(to_right,hsl(180_100%_50%/0.15)_0%,hsl(180_100%_50%/0.08)_50%,hsl(0_0%_2%)_100%)]"></div>
          ...
          <div className="absolute right-0 top-0 bottom-0 w-1/4 pointer-events-none z-0">
            <div className="absolute inset-0 bg-[linear-gradient(to_left,hsl(180_100%_50%/0.15)_0%,hsl(180_100%_50%/0.08)_50%,hsl(0_0%_2%)_100%)]"></div>
            <div className="absolute inset-0 bg-[linear-gradient(to_bottom,hsl(0_0%_2%)_0%,transparent_50%,transparent_100%)]"></div>
          </div>
          {/* Bottom fade to black - smooth transition */}
          <div className="absolute bottom-0 left-0 right-0 h-[600px] pointer-events-none z-10">
            <div className="absolute inset-0 bg-[linear-gradient(to_bottom,transparent_0%,hsl(180_100%_50%/0.03)_25%,hsl(180_100%_50%/0.02)_50%,hsl(180_100%_50%/0.01)_75%,hsl(0_0%_2%)_100%)]"></div>
          </div>
          <Lines />
        </div>
      </div>
