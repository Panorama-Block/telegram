    ...
    >
      <Container size="md" className="py-8 sm:py-12">
        <Stack direction="vertical" gap="xl" className="max-w-lg mx-auto">
          ...
          {/* Wallet Connection Card with Glassmorphism */}
          <Card
            variant="glass"
            size="lg"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
            <Card variant="ghost" size="sm" className="text-center bg-white/5 backdrop-blur-lg border border-white/10">
              <Stack direction="vertical" gap="sm" align="center">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">Non-custodial wallet connection</p>
                </div>
              </Stack>
            </Card>
            ...
            <Card variant="ghost" size="sm" className="text-center bg-white/5 backdrop-blur-lg border border-white/10">
              <Stack direction="vertical" gap="sm" align="center">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">Smart trading insights</p>
                </div>
              </Stack>
            </Card>
          </div>
