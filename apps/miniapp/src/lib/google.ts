...
export async function sendConfirmationEmail(data: AllocationPayload): Promise<void> {
  ...
  const html = `
    ...
    <body bgcolor="#050505" style="margin:0;padding:0;background-color:#050505;font-family:'Courier New',monospace;color:#f5f5f5;">
      <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#050505" style="background-color:#050505;padding:40px 0;">
        <tr><td align="center">
          <table width="560" cellpadding="0" cellspacing="0" bgcolor="#0a0a0a" style="background-color:#0a0a0a;border:1px solid #1a1a1a;border-radius:16px;overflow:hidden;">

            <!-- Header -->
            <tr>
              <td bgcolor="#0d1e1e" style="background-color:#0d1e1e;padding:32px 40px 24px;border-bottom:1px solid #111111;">
                <p style="margin:0;font-size:11px;letter-spacing:0.2em;text-transform:uppercase;color:#22d3ee;">Panorama Block</p>
            ...
            <tr>
              <td bgcolor="#0a0a0a" style="background-color:#0a0a0a;padding:32px 40px;">
                ...
                <!-- Summary box -->
                <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#111111" style="background-color:#111111;border:1px solid #1c1c1c;border-radius:12px;margin-bottom:24px;">
                  <tr><td style="padding:20px 24px;">
                    ...
                    ${row('Pre-seed price', '$0.025 per PANBLK')}
                    ${row('Est. value at listing', `$${(data.tokens * 0.08).toLocaleString()} USD`)}
                  </td></tr>
                </table>

                <!-- Next steps -->
                <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#0a1e20" style="background-color:#0a1e20;border:1px solid #0e3a3e;border-radius:12px;margin-bottom:24px;">
                  <tr><td style="padding:16px 20px;">
                    <p style="margin:0 0 8px;font-size:10px;letter-spacing:0.2em;text-transform:uppercase;color:#22d3ee;">What happens next</p>
                    <p style="margin:0;font-size:12px;color:#808080;line-height:1.7;">
                ...
                <p style="margin:0;font-size:11px;color:#4d4d4d;line-height:1.6;">
                  Questions? Reply to this email or reach us on Telegram at <a href="https://t.me/panoramablock" style="color:#22d3ee;text-decoration:none;">@panoramablock</a>.
                </p>
              </td>
            </tr>
...
export async function sendAdminNotification(data: AllocationPayload): Promise<void> {
  ...
  const html = `
    ...
    <body bgcolor="#050505" style="margin:0;padding:0;background-color:#050505;font-family:'Courier New',monospace;color:#f5f5f5;">
      <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#050505" style="background-color:#050505;padding:40px 0;">
        <tr><td align="center">
          <table width="520" cellpadding="0" cellspacing="0" bgcolor="#0a0a0a" style="background-color:#0a0a0a;border:1px solid #1a1a1a;border-radius:16px;overflow:hidden;">
            <tr>
              <td bgcolor="#0a0a0a" style="background-color:#0a0a0a;padding:24px 32px;border-bottom:1px solid #111111;">
                <p style="margin:0;font-size:10px;letter-spacing:0.2em;text-transform:uppercase;color:#22d3ee;">New Allocation Request</p>
            ...
            <tr>
              <td bgcolor="#0a0a0a" style="background-color:#0a0a0a;padding:24px 32px;">
...
function row(label: string, value: string): string {
  return `
    <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:8px;">
      <tr>
        <td style="font-size:11px;color:#595959;width:50%;">${label}</td>
        <td style="font-size:11px;color:#cccccc;text-align:right;">${value}</td>
      </tr>
    </table>
  `
}
