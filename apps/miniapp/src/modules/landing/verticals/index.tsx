...
const Verticals = () => {
  return (
    <div id="vision" className="relative flex flex-col gap-8 mt-32 overflow-hidden">
      ...
      <div className="relative py-8 mt-12 z-10">
        <div className="flex flex-col md:flex-row gap-4 md:gap-6 md:px-8 lg:px-12 justify-center items-center">
          <Image src={vertical1} alt="" className="rounded-[20px] object-cover" width={550} height={550} />
          <Image src={vertical2} alt="" className="rounded-[20px] object-cover" width={550} height={550} />
          <Image src={vertical3} alt="" className="rounded-[20px] object-cover" width={550} height={550} />
        </div>
      </div>
    </div>
  )
